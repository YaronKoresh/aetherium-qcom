@echo off
REM Aetherium Q-Com Installer for Windows
REM This script handles Python and package installation with automatic privilege handling.
...
echo.
echo Now proceeding with Aetherium Q-Com installation...
goto install_package_standard
...
echo You can now run the application using the 'run_aeterium.bat' script.
pause
